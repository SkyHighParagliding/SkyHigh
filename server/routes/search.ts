...
const ADMIN_NAV_INDEX = [
  ...
  { name: "News & Events", path: "/admin/news", description: "Post announcements, club news, and manage TidyHQ events integration." },
  ...
  { name: "Safety Officers", path: "/admin/safety-officers", description: "Manage the safety officer and committee member directory." },
  { name: "Smart Assistant Settings", path: "/admin/ai-assistant", description: "Configure public Smart search assistant behaviour, reference documents, and prompts." },
  { name: "Social Media", path: "/admin/social-media", description: "Manage footer social media links (Facebook, Instagram, Telegram, etc)." },
  { name: "Admin Users", path: "/admin/users", description: "Manage admin user accounts and access credentials." },
