...
UPDATE settings
SET value = REPLACE(CAST(value AS TEXT), 'pub-971a295c84fe4582b888c39e86cdbd8c.r2.dev', 'pub-d31362da23d54f83bb50efb9194c6b87.r2.dev')
WHERE key = 'imageLibrary'
  AND CAST(value AS TEXT) LIKE '%pub-971a295c84fe4582b888c39e86cdbd8c.r2.dev%';
