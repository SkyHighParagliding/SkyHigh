  ...
  const sections = [
    ...
    },
    {
      ...
      steps: [
        ...
        "Thermal (5:26 am daily): Fetches CAPE and boundary layer height at 0.09° resolution (~10km) for the coloured thermal overlay on the wind map. Takes 1–2 minutes for a full fetch. If some tiles fail, they are automatically retried up to 4 times at increasing intervals (+30 min, +60 min, +120 min, +240 min) — no action needed. The Last Run row shows the current retry status.",
        "7-Day (5:40 am daily): Fetches 8 days of weather at 0.5° resolution, keeps days 3–8 at four time slots per day (7am, 11am, 3pm, 7pm Melbourne time). Powers the 7-day outlook cards on each site's detail page.",
