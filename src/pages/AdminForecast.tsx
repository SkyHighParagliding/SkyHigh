...
const THRESHOLD_FIELDS: ThresholdField[] = [
  ...
  { key: "thermalHatchOpacity",     label: "Overcast hatch opacity",        description: "Opacity of the diagonal cross-hatch drawn over overcast areas. 0 hides the hatch entirely and relies on the grey wash alone. The hatch is drawn in screen space, so it appears to drift as you pan.", defaultVal: 0.35, unit: "", min: 0, max: 1, step: 0.05 },
