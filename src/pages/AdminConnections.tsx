...
export function AdminConnections() {
  ...
  const connections: ConnectionCard[] = [
    ...
    },
    {
      ...
      status: "connected",
      statusLabel: "Active",
      cost: "Usage-based — managed through Replit",
      howItConnects: "AI model access is provided through the hosting platform. A fallback chain tries multiple models in order if one fails.",
