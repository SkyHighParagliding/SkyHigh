      ...
      <div className="bg-background rounded-xl shadow-2xl flex flex-col w-full max-w-4xl" style={{ maxHeight: "90vh" }}>
        ...
        <div className="px-5 py-4 border-t border-border shrink-0 space-y-3">
          <div className="bg-muted/40 rounded-lg p-3 space-y-1 text-sm">
            ...
            <div className="text-xs text-muted-foreground">
              All three grids (Wind 0.15°, Thermal 0.09°, Extended 0.5°) use these bounds. Thermal and Extended are clipped to land plus a 0.2° coastal buffer server-side, cutting their point count by ~40%; Wind fetches the full rectangle so wind particles have no dead zones.
            </div>
          </div>
