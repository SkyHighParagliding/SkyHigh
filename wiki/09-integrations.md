...
| UI Label | Internal Flag | Effect |
|---|---|---|
| **Committee** | `isCommittee` | Marks the contact as a committee member |
| **Safety Committee** | `isSafetyCommittee` | Marks as safety committee (shows on Safety page) |
| **Position Title** | `isPosition` | Sets the contact's position to the group name (e.g. "President", "Treasurer") |
| **Contractor** | `isContractor` | Marks as a contractor |
| **Parks Vic** | `isParksVic` | Marks as Parks Victoria contact |
...
### Special Note: Safety Officer Titles (SO vs SSO)

When you map a group as **Safety Committee**, the system automatically:
1. Marks the contact as `isSafetyCommittee=1` (shows on Safety page)
2. Extracts the officer type from the group name:
   - Group name contains **"SSO"** → displays as **Senior Safety Officer**
   - Group name contains **"SO"** (but not SSO) → displays as **Safety Officer**

Example: Create two groups in TidyHQ named "SSO" and "SO" and map both as **Safety Committee**. When members are imported or their membership changes, the system will automatically assign the correct title based on the group name.
